...
class SimpleMapTest {
    ...
    void whenTriplePut() {
        ...
        assertThat(map.put(7, "8")).isFalse();
    }
    ...
    void whenGetTheSame() {
        map.put(5, "8");
        map.put(6, "8");
        assertThat(map.get(8)).isEqualTo(map.get(9));
    }

    @Test
    void whenPutInTheSameIndex() {
        map.put(0, "0");
        assertThat(map.put(8, "8")).isFalse();
    }

    @Test
    void whenInvalidRemove() {
        assertThat(map.remove(7)).isFalse();
    }

    @Test
    void whenInvalidRemoveAndCheckSize() {
        assertThat(map).hasSize(4);
        map.remove(6);
        assertThat(map).hasSize(4);
    }
